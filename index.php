...
if( !$get['raw'] ) {
  ...
  if( $error ) {
    $get['page'] = 'Error';
    echo '<meta name="description" content="'.strip_tags( ERROR ).'"/>'."\n";
    echo '<meta name="DC.Title" content="'.ERROR_TITLE.'"/>'."\n";
    echo '<meta name="DC.Description" content="'.strip_tags( ERROR ).'"/>'."\n";
    echo '<title>'.FRAMEWORK_TITLE.' - '.ERROR_TITLE.'</title>'."\n";
  } else {
    echo '<meta name="description" content="'.strip_tags( DESCRIPTION ).'"/>'."\n";
    echo '<meta name="keywords" content="'.KEYWORDS.'"/>'."\n";
    echo '<meta name="DC.Title" content="'.TITLE.'"/>'."\n";
    echo '<meta name="DC.Description" content="'.strip_tags( DESCRIPTION ).'"/>'."\n";
  ...
  else echo '<link rel="stylesheet" type="text/css" href="'.FRAMEWORK_ROOT.'/page.css"/>';
  # Ende CSS
